...
/**
 * BlogSection — preserved home-page blog preview (Req 16.1, 16.4).
 *
 * Shows the most recent posts with category filtering and opens a post in the
 * preserved {@link BlogModal}. Migrated to TypeScript with no behavioral change.
 */
  ...
  return (
    <section id="blog" className="py-20 bg-white dark:bg-stone-900">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-5xl font-bold mb-4 bg-gradient-to-r from-teal-600 to-blue-600 bg-clip-text text-transparent">
            Technical Blog
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Insights from building scalable systems and solving complex
          ...
          {filteredBlogs.slice(0, 3).map((blog, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors duration-300">
                  {blog.title}
                </h3>
        ...
        >
          <div className="bg-gradient-to-r from-teal-50 to-blue-50 dark:from-teal-900/20 dark:to-blue-900/20 rounded-2xl p-8 border border-teal-200 dark:border-teal-800">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              I&apos;m always excited to talk about software engineering,
              architecture patterns, and lessons learned from building scalable
              systems.
            </p>
            <a
              href="#contact"
      ...
      {/* Blog Modal */}
      <BlogModal blog={selectedBlog} isOpen={isModalOpen} onClose={closeBlog} />
    </section>
  );
};
